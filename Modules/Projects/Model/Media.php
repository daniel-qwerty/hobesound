...
class Projects_Model_Media extends Com_Module_Model {

    /**
     *
     * @return Projects_Model_Media 
     */
    ...
    public function getListByProject($ProId, $lanId) {
        $db = new Entities_Media();
        return $db->getAll($db->getListQuery()->where("MedProId={$ProId}")->andWhere("MedLanId={$lanId}")->orderBy("MedId"));
    }
