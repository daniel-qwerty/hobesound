...
class Blog_Controller_Admin extends Admin_Controller_Admin {
    ...
    public function Add() {
        ...
        if ($this->isPost()) {
            ...
            $id = Blog_Model_Blog::getInstance()->doInsert($this->getPostObject(), $languages, $header, $banner);
    ...
    public function Edit() {
        ...
        if ($this->isPost()) {
            ...
            Blog_Model_Blog::getInstance()->doUpdate(get('id'), $this->getPostObject(), $header, $banner);
