...
class News_Widget_NewsSport extends Com_Object {
    ...
    public function render() {
        ...
        $list = News_Model_New::getInstance()->getListSport($this->lan->LanId, $this->limit, $this->category);
        foreach ($list as $new) {
            ?>
