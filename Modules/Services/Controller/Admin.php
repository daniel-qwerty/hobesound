...
class Services_Controller_Admin extends Admin_Controller_Admin {
    ...
    public function Add() {
        ...
        if ($this->isPost()) {
            ...
            $logogray = "";
            if (Com_File_Handler::getInstance()->setFile(get("LogoGray"))->hasErrors()) {
                Com_Wizard_Messages::getInstance()->addMessage(MESSAGE_INFORMATION, "El Archivo Seleccionado no pudo ser guardado por favor Intente Nuevamente");
            } else {
                if (!(Com_File_Handler::getInstance()->saveFile("Resources/Uploads/Image/"))) {
                    Com_Wizard_Messages::getInstance()->addMessage(MESSAGE_INFORMATION, "El Archivo Seleccionado no pudo ser guardado por favor Intente Nuevamente");
                } else {
                    $logogray = Com_File_Handler::getInstance()->getFileName();
                }
            }
            ...
            $id = Services_Model_Service::getInstance()->doInsert($this->getPostObject(), $languages, $logo, $logogray, $image);
    ...
    public function Edit() {
        ...
        if ($this->isPost()) {
            ...
            Services_Model_Service::getInstance()->doUpdate(get('id'), $this->getPostObject(), $logo, $logogray, $image);
        ...
        $this->assign('LogoGray', $entity->SerLogoGray);
